...
- **[agentic-ops](https://github.com/Ariel-J-Lee/agentic-ops)** — Supporting systems-design reference for governed multi-agent engineering delivery: scoped work packages, handoff queues, review checkpoints, and durable merged state.
